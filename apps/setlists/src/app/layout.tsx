...
export const metadata: Metadata = {
  title: "Setlists",
  description: "Turn a setlist into practice material, licks and Helix patches",
  appleWebApp: {
    capable: true,
  ...
  return (
    <html lang="en" className={`${geistSans.variable} h-full antialiased`} suppressHydrationWarning>
      <head>
        ...
        />
        {/* Rewrite root-absolute /api/* URLs to include the Next basePath, so the
            app works behind the music-apps proxy at /setlists. */}
        <script dangerouslySetInnerHTML={{ __html: basepathShimSource("/setlists") }} />
      </head>
